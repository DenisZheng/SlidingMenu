...
public class WindowView extends BaseView {

	public WindowView(Context context, DataModel _info) {
		super(context, _info, R.layout.window_box);
...
//	    	}
//	    }
		TextView tv = (TextView)this.GetView().findViewById(R.id.window_Id);
		tv.setText(this.getShowInfo().getOtherName());
		
		ImageView onBtn = this.getImageViewById(R.id.window_on_btn);
		...
		ImageView offBtn = this.getImageViewById(R.id.window_off_btn);
