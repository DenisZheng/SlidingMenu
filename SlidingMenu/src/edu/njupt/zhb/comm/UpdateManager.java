...
public class UpdateManager {
	...
	private String downPath = "http://www.cseej.com/";
	private String appName = "InCloud.apk";
	private String appVersion = "InCloud.json";
	...
	private boolean getServerVersion() {
		...
		try {
			String url = downPath + appVersion;
			String newVerJSON = getUpdataVerJSON(url);
			...
			if (jsonArray.length() > 0) {
				...
				try {
					...
					// Toast.makeText(mContext,String.valueOf(newVerCode),
	...
	private boolean isUpdate() {
		if (getServerVersion()) {
			int currentCode = getVersionCode(mContext);
	...
	private int getVersionCode(Context context) {
		...
		try {
			...
			versionCode = context.getPackageManager().getPackageInfo(
					"edu.njupt.zhb.slidemenu", 0).versionCode;
		...
		public void run() {
			try {
				...
				if (Environment.getExternalStorageState().equals(
					...
					URL url = new URL(downPath + appName);
					// 创建连接
